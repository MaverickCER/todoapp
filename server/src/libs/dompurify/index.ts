          ...
          if (!href) {
            ...
            try {
              ...
              if (
                ...
                !(await sanitizeHtml.isValidMedia(href, "audio"))
              ) {
                ...
                !(await sanitizeHtml.isValidMedia(href, "image"))
              ) {
                ...
                !(await sanitizeHtml.isValidMedia(href, "video"))
              ) {
                ...
                const ogImage = metaDoc
                  .querySelector('meta[property="og:image"]')
                  ?.getAttribute("content");
                const twitterImage = metaDoc
              ...
              anchor.innerText =
                anchor.innerText + ` (true-link: ${url.hostname})`;
            } catch (_error) {
