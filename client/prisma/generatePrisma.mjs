...
// Directory paths
const modelsDir = path.resolve('./src/libs/prisma/models');
const templatesDir = path.resolve('./src/libs/prisma/templates');
const outputPrismaFile = path.resolve('./prisma/schema.prisma');
const outputIndexFile = path.resolve('./src/libs/prisma/index.ts');
